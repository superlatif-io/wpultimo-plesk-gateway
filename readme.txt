...
Contributors: superlatif
Donate link: https://superlatif.io/donate
...
Installing "WP Ultimo Plesk Gateway" can be done either by searching for "WP Ultimo Plesk Gateway" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
